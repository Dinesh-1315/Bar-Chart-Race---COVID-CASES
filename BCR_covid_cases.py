...
#loading the dataset
data = pd.read_csv(r"C:\Users\pc\Desktop\Project BCR\COVID-19_WHO.csv", encoding="latin")
print(data.head(5))
#print(data.columns)
#print(data.describe)
...
#t.to_csv(r"C:\Users\pc\Desktop\updated_demo02.csv",index = False)

#setting "Date" as an index
df_final.set_index("Date",inplace=True)
#sorted dataframe
df_sorted = df_final.sort_values(by= '16-03-2022',axis=1,ascending= False)
#saving the dataset to the specific location
df_sorted.to_csv(r"C:\Users\pc\Desktop\Project BCR\extra files\total cases 0001.csv", index = True)
#transpose 
df_trans=df_sorted.transpose()
df_trans.to_csv(r"C:\Users\pc\Desktop\Project BCR\extra files\trans total cases 0001.csv", index = True)
df_final= df_sorted.iloc[:,1:100]
#df_final= df_sorted.iloc[150:250,[1,22,2,33,14,5,75,120,155,45,96,112,147,26,35,8,9,19,11]]
